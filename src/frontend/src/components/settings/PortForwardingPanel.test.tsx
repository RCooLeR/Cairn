...
import { DEFAULT_READ_TIMEOUT_MS } from "../../api/boundedRead";
...
describe("PortForwardingPanel", () => {
  ...
  it("releases a stalled initial status read and permits retry", async () => {
    vi.useFakeTimers();
    const cancel = vi.fn();
    portForwardServiceMock.GetStatus.mockReturnValueOnce(
    ...
    expect(screen.getByRole("alert")).toHaveTextContent(
      "Port forwarding status timed out. Please retry.",
    );
