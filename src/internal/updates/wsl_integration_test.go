...
func TestManagerRealWSLUpdateAndRebuildSmoke(t *testing.T) {
	...
	// The Go module lives under src; keep generated integration projects in
	// the repository's ignored scratch directory, outside application source.
	scratchRoot := filepath.Join(packageDir, "..", "..", "..", ".scratch", "wsl-updates")
