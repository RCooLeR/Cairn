...
```powershell
./scripts/run-release-validation.ps1 -Suite checklist,manual-matrix,security,performance,soak-smoke,ui-release -SoakDuration 30s -SoakTimeout 5m
```
